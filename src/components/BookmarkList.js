...
const BookmarkList = () => {
  ...
  const { bookmarks, editBookmarks, removeBookmarks, getBookmarks } = useContext(bookmarkContext);  
            ...
            const {_id, title, tag, date, url} = bookmark;
                <div className="flex items-center bg-gray-100 mb-10 shadow" key={_id}>
                    <div className="flex-auto text-left px-4 py-2 m-2">
                        ...
                        <span className="inline-block text-sm font-semibold mt-1">{url}</span>
                    </div>
                    <div className="flex-auto text-right px-4 py-2 m-2">
                        ...
                        <button onClick={() => removeBookmarks(_id)} className="block bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-full inline-flex items-center">
